...
function Cards() {
  return (
    <>
      <section
        class="text-gray-600 body-font relative overflow-hidden"
        style={{
      ...
      >
        ...
        <div className="relative z-10">
          <div class="container px-5 py-24 mx-auto pt-50">
                ...
                >
                  ...
                  <div class="p-6">
                    ...
                    <p class="leading-relaxed mb-3 text-black text-sm">
                      Morning Glory is a fast-growing climbing vine known for
                      its vibrant blue trumpet-shaped flowers. These blooms open
                      in the early morning and symbolize love, affection, and
              ...
              <div class="p-4 md:w-1/3">
                ...
                >
                  ...
                  <div class="p-6">
                    ...
                    <p class="leading-relaxed mb-3 text-black text-sm">
                      The Lotus is a sacred aquatic flower that blooms
                      beautifully above the water's surface. It symbolizes
                      purity, wisdom, resilience, and spiritual enlightenment in
                      many cultures.
                    </p>
                    <div class="flex items-center flex-wrap ">
                      <a class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">
                ...
                >
                  ...
                  <div class="p-6">
                    ...
                    <p class="leading-relaxed mb-3 text-black text-sm">
                      ...
                      celebrated for its delicate petals and enchanting
                      fragrance. It represents love, admiration, elegance, and
                      timeless beauty.
                    </p>
                    <div class="flex items-center flex-wrap ">
                      <a class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">
              ...
              <div class="p-4 md:w-1/3">
                ...
                >
                  ...
                  <div class="p-6">
                    ...
                    <p class="leading-relaxed mb-3 text-black text-sm">
                      White Frangipani produces creamy white petals with a
                      golden center and a sweet fragrance. It is widely planted
                      in tropical landscapes for its graceful appearance and
                      relaxing aro
                    </p>
                    <div class="flex items-center flex-wrap">
                      <a class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">
